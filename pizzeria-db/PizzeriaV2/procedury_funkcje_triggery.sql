...
-- Zwraca cenê pojedynczego zamówienia.
...
-- Sprawdzanie numeru zamówienia klienta. Jeœli trzecie z kolei to naliczana zni¿ka 20%, jeœli pierwsze zamówienie to 10%.
...
-- Po wybraniu dania zmiejszamy iloœæ sk³adników w magazynie.
...
-- Po dodaniu dodatkowych sk³adników, zmiejszmay iloœæ sk³adników na magazynie.
